...
TASK_LIST = ['PopQA','PubHealth','Arc', 'TriviaQA', 'ASQA', 'Factscore', 
             'HotPotQA', 'StrategyQA', '2WikiMultiHopQA','Feverous', 'MMLU','AVeriTeC','Fever2','Hover'] 
...
def get_dataset(args) -> object:
    ...
    from raglab.dataset.AVeriTeC import AVeriTeC
    ...
    from raglab.dataset.Fever2 import Fever2
    ...
    from raglab.dataset.Fever2 import Fever2
    from raglab.dataset.Hover import Hover
    ...
    elif 'AVeriTeC' == args.task:
        EvalData = AVeriTeC(args)
    elif 'Arc' == args.task:
    ...
    elif 'Fever2' == args.task:
        EvalData = Fever2(args)    
    elif 'Hover' == args.task:
        EvalData = Hover(args)
    elif 'MMLU' == args.task:
        EvalData = MMLU(args)
    else:
