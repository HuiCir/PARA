...
from raglab.retrieval import ColbertRetrieve, ColbertApi
from raglab.language_model import OpenaiModel, HF_Model, HF_VLLM, Lora_Model, GLMModel
...
class NaiveRag:
    def __init__(self, args):
        ...
        self.use_vllm = True#args.use_vllm
        # retrieval args
    ...
    def inference(self, query: Optional[str] = None, mode = 'interact'):
        ...
        if 'interact' == mode:
            ...
            for idx, eval_data in enumerate(tqdm(self.eval_dataset)):
                ...
                evidence = eval_data[self.EvalData.InputStruction.pregiven_passages]
                ...
                if outputs != "":
                    self.success_answers += 1
                self.print_fn(f'\n success_answers:{self.success_answers}')
                # calculate metric
    ...
    def infer(self, query: str)->tuple[str,dict[str,Any]]:
        ...
        if self.realtime_retrieval:
            ...
            generation_track['cited passages'] = collated_passages
        else:
