...
def get_config():
    ...
    parser.add_argument('--num_gpu', type = int, default = 2, help = 'the number of gpu')
    parser.add_argument('--gpu_ids', type=int, nargs='+', default=1, help='GPU IDs to use (e.g., 0 1 2 3)')
    ...
    parser.add_argument("--dtype", type=str, default= "float16", help="all base model inference using half(fp16)")
